...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pokemon_evolutions', function (Blueprint $table) {
            $table->id();
            $table->ForeignIdFor(App\Models\PokemonVariety::class, "pokemon_veriety_id")->constrained()->onDelete('cascade');
            ...
            $table->ForeignIdFor(App\Models\Type::class, 'know_move_type_id')->constrained()->onDelete('cascade');
            ...
            $table->boolean('need_overwold_rain')->default(false);
